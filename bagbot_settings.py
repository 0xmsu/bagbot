...
# COPY EVERYTHING ABOVE THIS LINE TO A NEW FILE NAMED: bagbot_settings_overrides.py IN THIS SAME DIRECTORY (a.k.a folder) AND ADJUST AS NEEDED. DO NOT EDIT THIS FILE
